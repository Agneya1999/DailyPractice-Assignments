...
public class Problem6 {
	...
	public static void main(String[] args) {
		...
		System.out.println("Converting the given number to words");
		if(a==0) {
		...
		String[] two_digits =  { "Ten", "Eleven", "Twelve", "Thirteen", "Fourteen", "Fifteen", "Sixteen",
                "Seventeen", "Eighteen", "Nineteen" };

       String[] tens_multiple = { "", "", "Twenty", "Thirty", "Forty", "Fifty", "Sixty", "Seventy",
                "Eighty", "Ninety" };
       ...
       if(a==1) {
    	   ...
    	   if(c[0]-'0'>1) {
    		   if(c[1]-'0'==0) {
    			   ...
    			   System.out.print(tens_multiple[c[0]-'0']);
    	  ...
    	  if(c[1]-'0'==0&&c[2]-'0'==0) {
    		 ...
    		 System.out.print(" "+tens_power[c[1]-'0']);
